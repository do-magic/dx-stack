...
An Nx sync generator (`@dxs/next-skaffold:sync`) that generates the workspace's
...
plus a qualifying app's own `<project root>/Dockerfile` _if its framework was
recognized_, is generated and carries a `# Generated by @dxs/next-skaffold:sync`
